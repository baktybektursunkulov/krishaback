...
public class CacheControlFilterV2 implements Filter {

  private static final int DEFAULT_BUFFER_SIZE = 10240; // ..bytes = 10KB.
  private static final long DEFAULT_EXPIRE_TIME = 2678400000L; // ..ms = 31 days.
  ...
  public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
    ...
    boolean cache_ = gs.common.servlet.AttributeTools.getRequestBoolean(request, "cache", true);
    //CustomLogger.log("cache_=" + cache_);
    if (!cache_) {
    ...
    //int length = 100;
    long lastModified = new Date(114, 5, 20).getTime();

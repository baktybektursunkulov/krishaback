...
@ManagedBean
@ViewScoped
public class Jr_Rep_Col_Sort_Controller extends Abstract_Controller<Jr_Rep_Col_Sort> {

  List<Jr_Rep_Tpl_Col> jr_rep_tpl_col_list;
  
  public Jr_Rep_Col_Sort_Controller() {
    super(Jr_Rep_Col_Sort.class, "jr_rep_col_sort_list.xhtml", false);
  }

  public Jr_Rep_Col_Sort getJr_rep_col_sort() {
  ...
  public void refresh_jr_rep_tpl_col_list() {
    if (getJr_rep_col_sort().getJr_rep() != null && getJr_rep_col_sort().getJr_rep_t().getJr_rep_tpl() != null) {
      jr_rep_tpl_col_list = Jr_Rep_Tpl_Col_Manager.getCI().get_jr_rep_tpl_col_list(getJr_rep_col_sort().getJr_rep_t().getJr_rep_tpl_t().getJr_rep_tpl());
    } else {

...
@ManagedBean
@SessionScoped
public class Jr_Rep_List_Bean extends Abstract_List_Bean<Jr_Rep> {

  public Jr_Rep_List_Bean() {
    super("Jr_Rep", (Jr_Rep_Filter_Bean) jsf_funcs.findBean("jr_Rep_Filter_Bean"));
  }

  public LazyDataModel<Jr_Rep> getConverted_rec_list() {
    return getRec_list();
  }

  public Jr_Rep_Filter_Bean getFilter_bean_wrapped() {
    return (Jr_Rep_Filter_Bean) getFilter_bean();
  }

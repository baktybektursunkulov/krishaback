...
@Entity
@Table(name = "c_speed_unit")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class C_Speed_Unit extends Abstract_Entity {
  ...
  @Column(name = "c_speed_unit", unique = true, nullable = false)
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_speed_unit());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Speed_Unit other = (C_Speed_Unit) obj;
    if (!Objects.equals(this.getC_speed_unit(), other.getC_speed_unit())) {
      return false;
    }
    return true;
  }

...
@Entity
@Table(name = "c_volume_unit")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class C_Volume_Unit extends Abstract_Entity {
  ...
  @Column(name = "c_volume_unit", unique = true, nullable = false)
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_volume_unit());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Volume_Unit other = (C_Volume_Unit) obj;
    if (!Objects.equals(this.getC_volume_unit(), other.getC_volume_unit())) {
      return false;
    }
    return true;
  }

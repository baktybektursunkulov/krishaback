...
@Entity
@Table(name="c_usr_review_answer")
@Proxy(lazy=false) 
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)

public class C_Usr_Review_Answer extends Abstract_Entity {

  //fields
  private Integer c_usr_review_answer;
  ...
  @Column(name="c_usr_review_answer", unique=true, nullable=false)
  public Integer getC_usr_review_answer() {
    return this.c_usr_review_answer;
  }
  public void setC_usr_review_answer(Integer c_usr_review_answer) {
    this.c_usr_review_answer = c_usr_review_answer;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_usr_review_answer());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Usr_Review_Answer other = (C_Usr_Review_Answer) obj;
    if (!Objects.equals(this.getC_usr_review_answer(), other.getC_usr_review_answer())) {
      return false;
    }
    return true;
  }

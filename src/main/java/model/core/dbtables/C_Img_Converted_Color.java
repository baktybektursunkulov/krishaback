...
@Entity
@Table(name = "c_img_converted_color")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class C_Img_Converted_Color extends Abstract_Entity {

  //fields
  private Long c_img_converted_color;
  private Long c_img;
  ...
  @Column(name = "c_img_converted_color", unique = true, nullable = false)
  public Long getC_img_converted_color() {
    return this.c_img_converted_color;
  }

  public void setC_img_converted_color(Long img_converted_color) {
    this.c_img_converted_color = img_converted_color;
  }
  ...
  @Column(name = "img_color", nullable = false)
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_img_converted_color());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Img_Converted_Color other = (C_Img_Converted_Color) obj;
    if (!Objects.equals(this.getC_img_converted_color(), other.getC_img_converted_color())) {
      return false;
    }
    return true;
  }
  ...
  public Serializable getEntity_id() {
    return getC_img_converted_color();
  }

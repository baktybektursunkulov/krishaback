...
@Entity
@Table(name = "i_plain_txt")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class I_Plain_Txt extends Abstract_Entity {

  //fields
  private Integer i_plain_txt;
  ...
  @Column(name = "i_plain_txt", unique = true, nullable = false)
  public Integer getI_plain_txt() {
    return this.i_plain_txt;
  }

  public void setI_plain_txt(Integer i_plain_txt) {
    this.i_plain_txt = i_plain_txt;
  }
  ...
  @Transient
  public String getTxt_translation() throws Exception {
  ...
  public String getTxt_translation_3(Session session_, String lang_) throws Exception {
    if (lang_.equals("ru")) {
      txt_translation = getTxt();
    } else {
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getI_plain_txt());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final I_Plain_Txt other = (I_Plain_Txt) obj;
    if (!Objects.equals(this.getI_plain_txt(), other.getI_plain_txt())) {
      return false;
    }
    return true;
  }

...
@Entity
@Table(name = "c_weight_unit")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)

public class C_Weight_Unit extends Abstract_Entity {

  //fields
  private Integer c_weight_unit;
  private String code;
  private String name;
  ...
  @Column(name = "c_weight_unit", unique = true, nullable = false)
  public Integer getC_weight_unit() {
    return this.c_weight_unit;
  }

  public void setC_weight_unit(Integer c_weight_unit) {
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_weight_unit());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Weight_Unit other = (C_Weight_Unit) obj;
    if (!Objects.equals(this.getC_weight_unit(), other.getC_weight_unit())) {
      return false;
    }
    return true;
  }

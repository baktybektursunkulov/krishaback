...
@Entity
@Table(name = "c_right_kind")
@Proxy(lazy = false)
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class C_Right_Kind extends Abstract_Entity {
  ...
  @Column(name = "c_right_kind", unique = true, nullable = false)
  ...
  public int hashCode() {
    int hash = 7;
    hash = 89 * hash + Objects.hashCode(this.getC_right_kind());
    return hash;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final C_Right_Kind other = (C_Right_Kind) obj;
    if (!Objects.equals(this.getC_right_kind(), other.getC_right_kind())) {
      return false;
    }
    return true;
  }
